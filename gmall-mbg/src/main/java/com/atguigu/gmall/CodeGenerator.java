...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("C:\\MyWork\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("Mr.Dong");
        ...
        dsc.setUrl("jdbc:mysql://192.168.107.128:3307/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
